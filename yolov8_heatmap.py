...
def letterbox(im, new_shape=(1536, 48), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True, stride=32):
...
class yolo_heatmap:
    ...
    def process(self, img_path, save_path):
        ...
        img, _, (top, bottom, left, right) = letterbox(
            img,
            new_shape=self.img_size,  # 直接传递元组
            auto=True
        )
...
def get_params():
    params = {
        'weight': 'D:/study/Textile_defects/ultralytics-v8/ultralytics-main/runs/detect/MAC/weights/best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'D:/study/Textile_defects/ultraytics/ultralytics-main/datasets/MP_test/cam1202304241010020.jpg', 'result')
